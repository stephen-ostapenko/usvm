...
fun read_types_instance1(buffReader: BufferedReader, id: Int): types_instance1 {
	val res = types_instance1()
    if (id != -1) {
        if (ptrMap.containsKey(id)) {
            return ptrMap[id] as types_instance1
        }
        ptrMap[id] = res
